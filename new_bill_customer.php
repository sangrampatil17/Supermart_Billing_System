        ...
        <div class=container>
          ...
          <div class="row">
            <div class="col-lg-12 pt-2">
              ...
              <div class="col-md-9 col-9 pt2 text-right">
              <label for="" id="total_product_weight"></label>
            </div>
            </div>
    ...
    <script>
      ...
      function generate_bill() {
        ...
        let mobile_number_length = document.getElementById("mobile_number").value.length;
          ...
          let basket_no= "<?php echo $basket_no ?>";
          $.ajax({
            url: "new_bill_customer_backend.php",
            type: "POST",
            data: {
      ...
      function showbill() {
        ...
        $.ajax({
          ...
          success: function (data, status) {
            ...
            let total_product_weight=document.getElementById("hidden_total_product_weight").value;
              document.getElementById("total_product_weight").innerHTML="Weight: <b class='text-danger'>"+total_product_weight+"</b>";
            if (bill_count > 0) {
